...
contract TokenCreateContract is ExpiryHelper {
    ...
    function createFungible(
        ...
        IHederaTokenService.KeyValue memory secondAdminKeyValue;
        ...
        myToken.expiry = createAutoRenewExpiry(
            autoRenewAccount,
            autoRenewPeriod
        );

        // call HTS precompiled contract, passing 200 as initial supply and 8 as decimals
        (int responseCode, address token) = HederaTokenService
    ...
    function createFungibleWithFees(
        ...
        fixedFees[1] = createFixedTokenFee(
            5,
        ...
        returns (address createdTokenAddress)
    {
        ...
        (int responseCode, address tokenAddress) = HederaTokenService
            .createFungibleToken(token, 200, 8);
